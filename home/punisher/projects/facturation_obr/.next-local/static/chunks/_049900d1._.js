(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_049900d1._.js", {
...
function ClientsPage() {
    ...
    const [isLoadingName, setIsLoadingName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const fetchClients = async ()=>{
        ...
        try {
            ...
            const formattedClients = data.map((client)=>({
                    ...
                    vat_taxpayer: Boolean(client.vat_taxpayer),
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClientsPage.useEffect": ()=>{
            const lookupNif = {
                "ClientsPage.useEffect.lookupNif": async (nif)=>{
                    try {
                        ...
                        if (tinData.success && tinData.result.taxpayer?.[0]?.tp_name) {
                            setFormData({
                                "ClientsPage.useEffect.lookupNif": (prev)=>({
                                        ...prev,
                                        name: tinData.result.taxpayer[0].tp_name
                                    })
                            }["ClientsPage.useEffect.lookupNif"]);
                        } else {
            ...
            const timeoutId = setTimeout({
                "ClientsPage.useEffect.timeoutId": ()=>{
                    const cleanNif = formData.nifClient.trim();
                    if (cleanNif.length >= 9) {
                        lookupNif(cleanNif);
                    }
                }
            }["ClientsPage.useEffect.timeoutId"], 500);
            return ({
                "ClientsPage.useEffect": ()=>clearTimeout(timeoutId)
            })["ClientsPage.useEffect"];
        }
    }["ClientsPage.useEffect"], [
        formData.nifClient
    ...
    const columnsWithActions = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$data$2d$table$2f$columns$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clientColumns"],
        {
            id: "actions",
            header: "Actions",
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        isLoadingName && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ClientsPage, "L2fee3m4UWPhm43BNgeNWjn9Gsc=", false, function() {
    return [
...
//# sourceMappingURL=_049900d1._.js.map